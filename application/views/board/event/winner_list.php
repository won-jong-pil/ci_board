        ...
        <article class="content">
            <section class="contents_inner">
                ...
                <div class="contents_area mypage faq">
                    ...
                    <div class="box">
                        <p><img src="/images/mypage/img_bullet_small.png" /> 이벤트 당첨자를 확일 하실 수 있습니다.</p>
                        <div class="table_wrap">
                            <table class="list">
                                <caption>이벤트 당첨자 리스트</caption>
                                <colgroup>
                                    <col width="91px" />
                                    <col width="629px" />
                                </colgroup>
                            ...
                            <?php if(count($result['result']) > 0):?>
                                ...
                                <tr>
                                    ...
                                    <td class="left"><a href="#none;"><?php echo $list['title'];?> 당첨자 발표</a></td>
                                </tr>
                                <tr>
                                    <td class="even" colspan="2">
                                        <dl>
                                            <dt>당첨자</dt>
                                            <dd><?php echo $list['winner_contents'];?></dd>
                                        </dl>
                                    </td>
                                </tr>
                                <?php endforeach;?>
