...
if(substr($config['base_url'], -1) != '/')  $config['base_url'] = $config['base_url']. '/';
...
|
*/
$config['log_threshold'] = array(1, 2, 5);
...
|
*/
$config['encryption_key'] = ';l;wlrhkjdfi930-2ijyrlfknmn;lk;akasd9guuheiro';
...
$config['csrf_cookie_name'] = 'my_cookie_name';
